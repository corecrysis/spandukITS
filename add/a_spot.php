...
-->
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <center>
                        <h1 class="page-header">Tambah Spot Spanduk</h1> </center>
                </div>
            </div>
            <!--/.row-->
            <div class="row">
                <form action="add_a_spot.php" method="post">
                    <div class="form-group">
                        <label for="email" class="col-sm-6 control-label">Nama Spot</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="m_nama_spot" placeholder="robotika" required> </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-sm-6 control-label">Kuota Spanduk</label>
                        <div class="col-sm-4">
                            <input type="number" autofocus="" class="form-control" name="m_jml_spot" min="1" max="20" required> </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-sm-6 control-label">Panjang Spanduk</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="m_lebar_spot" placeholder="robotika"  onkeypress="checkNumber(event)" required> </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-sm-6 control-label">Tinggi Spanduk</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="m_tinggi_spot"  onkeypress="checkNumber(event)" placeholder="robotika" required> </div>
                    </div>
                    <div class="form-group">
